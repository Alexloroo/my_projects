...
| [ESP32 Remote Robot Controller](https://github.com/Alexloroo/my_projects/tree/main/ESP32-robot-controller)                               | Удалённое управление мобильным роботом на базе ESP32 через веб-интерфейс.  Включает сервер на ESP32, HTML/CSS/JS интерфейс и обработчики команд. Прокт занял **3** место на **IT Fest 2024** в Алмате | ESP32 (Arduino), WiFi.h, ESP32Servo, WebServer, HTML/CSS/JS, Arduino |

## Инструменты

Основные инструменты, которые я использовал в проектах:
